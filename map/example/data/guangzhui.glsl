/*
 * @Author: your name
 * @Date: 2021-03-25 17:21:13
 * @LastEditTime: 2021-03-30 09:38:17
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: \kvmap\example\data\guangzhui.js
 */
...
float shadow(vec3 origin, vec3 ray) { 
    ...
    return 0.0; 
    float tSphere3 = 
    intersectSphere(origin, ray, sphereCenter3, sphereRadius3); 
...
vec3 calculateColor(vec3 origin, vec3 ray, vec3 light) {   
    ...
    for(int bounce = 0; bounce < 5; bounce++) {     
        ...
        if(t == tRoom.y) {       
            ...
            normal = normalForSphere(hit, sphereCenter1, sphereRadius1); 
            else if(t == tSphere2) 
            normal = normalForSphere(hit, sphereCenter2, sphereRadius2); 
