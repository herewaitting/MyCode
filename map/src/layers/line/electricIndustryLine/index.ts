...
import { LinePrimitiveImageColorFlowMaterial } from "../../../map/material/LinePrimitiveImageColorFlowMaterial";
...
export class ElectricIndustryLine extends Line<ILayerStyle> {
    ...
    protected createAppearance<ILayerStyle>(condition: string, style: ILayerStyle) {
        ...
        this.conditionMaterial[condition] = new LinePrimitiveImageColorFlowMaterial(style as any);
    }
    protected onStyle<ILayerStyle>(style: ILayerStyle): void {
        ...
        // this.material = new LinePrimitiveImageColorFlowMaterial(this.style);
        // this.appearance = {};
    ...
    protected deleteAppearance(condTxt: string) {
        if (this.conditionAppearance[condTxt]) {
            ...
            delete this.conditionAppearance[condTxt];
        }
    }
