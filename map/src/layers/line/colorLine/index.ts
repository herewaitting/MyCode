...
import { CreatePolylineGeometry, CreatePolylinePrimitive, KVAppearance, LinePrimitiveColorFlowMaterial } from "./config";
import { DefaultData } from "./data";
import { DefaultStyle, ILayerStyle } from "./style";

export class ColorLine<D> extends Line<D> {
    public static DefaultData = DefaultData;
    public workerFunName!: string;
    public temparr!: any[];
    private material!: LinePrimitiveColorFlowMaterial;
