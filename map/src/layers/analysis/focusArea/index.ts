...
export class FocusArea extends Analysis<ILayerStyle> {
    ...
    // public updateFocus(area: string) {
    //     if (!area) {
    //         return;
    //     }
    //     this.data = area;
    ...
    protected onHide(): void {
        ...
        (Cesium.ExpandBySTC as any).enableTailorBright = false;
    }
    protected onShow(): void {
        (this.viewer.scene.globe as any)._surface.tileProvider.applyTailor = true;
        (Cesium.ExpandBySTC as any).enableTailorBright = true;
    }
