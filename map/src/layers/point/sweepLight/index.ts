...
import { SweepLightMaterial } from "../../../map/material/SweepLightMaterial";
...
export class SweepLight extends Point<ILayerStyle> {
    ...
    protected onStyle<ILayerStyle>(style: ILayerStyle): void {
        ...
        this.material = new SweepLightMaterial(this.style);
