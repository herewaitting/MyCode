...
import { AlphaCylinderMaterial } from "../../../map/material/alphaCylinderMaterial";
...
export class AlphaCylinder extends Point<ILayerStyle> {
    public workerFunName!: string;
    public appearance: any;
    public VAO: any;
    private material!: AlphaCylinderMaterial;
    private conditionMaterial!: {
        [key: string]: AlphaCylinderMaterial;
    };
    ...
    protected onStyle<ILayerStyle>(style: ILayerStyle): void {
        ...
        this.material = new AlphaCylinderMaterial(this.style);
    ...
    protected createAppearance<ILayerStyle>(condition: string, style: ILayerStyle) {
        ...
        this.conditionMaterial[condition] = new AlphaCylinderMaterial(style as any);
    }
    private prepareVAO() {
        const splitNum = 30;
