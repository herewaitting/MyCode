...
var AutomaticUniforms = {
  ...
  /**
   * @description: ��չ��Դ����
   * @param {BOOL_VEC4} {x:�����⣬y:���Դ�� z:�۹�ƣ� w:��δʹ�� }
   */
  czm_extendLightSwitch: new AutomaticUniform({
    size: 1,
    datatype: WebGLConstants.BOOL_VEC4,
    getValue: function (uniformState) {
      return uniformState.extendLightSwitch || new Cartesian4(false,false,false,false);
    },
  }),
  czm_extendAmbientLightColor: new AutomaticUniform({
    size: 1,
    datatype: WebGLConstants.FLOAT_VEC3,
    getValue: function (uniformState) {
      return uniformState.extendAmbientLightColor || new Color(0,0,0);
    },
  }),
  czm_extendAmbientLightBrightness: new AutomaticUniform({
    size: 1,
    datatype: WebGLConstants.FLOAT,
    getValue: function (uniformState) {
      return uniformState.extendAmbientLightBrightness || 1.0;
    },
  }),
  czm_extendPointLightColor: new AutomaticUniform({
    size: 1,
    datatype: WebGLConstants.FLOAT_VEC3,
    getValue: function (uniformState) {
      return uniformState.extendPointLightColor || new Color(0,0,0);
    },
  }),
  czm_extendPointLightBrightness: new AutomaticUniform({
    size: 1,
    datatype: WebGLConstants.FLOAT,
    getValue: function (uniformState) {
      return uniformState.extendPointLightBrightness || 1.0;
    },
  }),
  czm_extendPointLightPositionWC: new AutomaticUniform({
    size: 1,
    datatype: WebGLConstants.FLOAT_VEC3,
    getValue: function (uniformState) {
      return uniformState.extendPointLightPositionWC || new Cartesian3(0,0,0);
    },
  }),
  czm_extendPointLightPositionEC: new AutomaticUniform({
    size: 1,
    datatype: WebGLConstants.FLOAT_VEC3,
    getValue: function (uniformState) {
      return uniformState.extendPointLightPositionEC || new Cartesian3(0,0,0);
    },
  }),
  czm_extendPointLightDistance: new AutomaticUniform({
    size: 1,
    datatype: WebGLConstants.FLOAT,
    getValue: function (uniformState) {
      return uniformState.extendPointLightDistance || 0.0;
    },
  }),
  czm_extendSpotLightColor: new AutomaticUniform({
    size: 1,
    datatype: WebGLConstants.FLOAT_VEC3,
    getValue: function (uniformState) {
      return uniformState.extendSpotLightColor || new Color(0,0,0);
    },
  }),
  czm_extendSpotLightBrightness: new AutomaticUniform({
    size: 1,
    datatype: WebGLConstants.FLOAT,
    getValue: function (uniformState) {
      return uniformState.extendSpotLightBrightness || 1.0;
    },
  }),
  czm_extendSpotLightPositionWC: new AutomaticUniform({
    size: 1,
    datatype: WebGLConstants.FLOAT_VEC3,
    getValue: function (uniformState) {
      return uniformState.extendSpotLightPositionWC || new Cartesian3(0,0,0);
    },
  }),
  czm_extendSpotLightPositionEC: new AutomaticUniform({
    size: 1,
    datatype: WebGLConstants.FLOAT_VEC3,
    getValue: function (uniformState) {
      return uniformState.extendSpotLightPositionEC || new Cartesian3(0,0,0);
    },
  }),
  czm_extendSpotLightDirectionWC: new AutomaticUniform({
    size: 1,
    datatype: WebGLConstants.FLOAT_VEC3,
    getValue: function (uniformState) {
      return uniformState.extendSpotLightDirectionWC || new Cartesian3(0,0,0);
    },
  }),
  czm_extendSpotLightDirectionEC: new AutomaticUniform({
    size: 1,
    datatype: WebGLConstants.FLOAT_VEC3,
    getValue: function (uniformState) {
      return uniformState.extendSpotLightDirectionEC || new Cartesian3(0,0,0);
    },
  }),
  czm_extendSpotLightDistance: new AutomaticUniform({
    size: 1,
    datatype: WebGLConstants.FLOAT,
    getValue: function (uniformState) {
      return uniformState.extendSpotLightDistance || 0;
    },
  }),
  czm_extendSpotLightCosNum: new AutomaticUniform({
    size: 1,
    datatype: WebGLConstants.FLOAT,
    getValue: function (uniformState) {
      return uniformState.extendSpotLightCosNum || 0;
    },
  }),
  // 平行光
  czm_extendParallelLight1Direction: new AutomaticUniform({
    size: 1,
    datatype: WebGLConstants.FLOAT_VEC3,
    getValue: function (uniformState) {
      return uniformState.extendParallelLight1Direction || 0;
    },
  }),
  czm_extendParallelLight1Brightness: new AutomaticUniform({
    size: 1,
    datatype: WebGLConstants.FLOAT,
    getValue: function (uniformState) {
      return uniformState.extendParallelLight1Brightness || 0;
    },
  }),
  czm_extendParallelLight1Color: new AutomaticUniform({
    size: 1,
    datatype: WebGLConstants.FLOAT_VEC3,
    getValue: function (uniformState) {
      return uniformState.extendParallelLight1Color || 0;
    },
  }),
  czm_extendParallelLight1Enable: new AutomaticUniform({
    size: 1,
    datatype: WebGLConstants.BOOL,
    getValue: function (uniformState) {
      return uniformState.extendParallelLight1Enable || 0;
    },
  }),


  czm_extendParallelLight2Direction: new AutomaticUniform({
    size: 1,
    datatype: WebGLConstants.FLOAT_VEC3,
    getValue: function (uniformState) {
      return uniformState.extendParallelLight2Direction || 0;
    },
  }),
  czm_extendParallelLight2Brightness: new AutomaticUniform({
    size: 1,
    datatype: WebGLConstants.FLOAT,
    getValue: function (uniformState) {
      return uniformState.extendParallelLight2Brightness || 0;
    },
  }),
  czm_extendParallelLight2Color: new AutomaticUniform({
    size: 1,
    datatype: WebGLConstants.FLOAT_VEC3,
    getValue: function (uniformState) {
      return uniformState.extendParallelLight2Color || 0;
    },
  }),
  czm_extendParallelLight2Enable: new AutomaticUniform({
    size: 1,
    datatype: WebGLConstants.BOOL,
    getValue: function (uniformState) {
      return uniformState.extendParallelLight2Enable || 0;
    },
  }),
};
