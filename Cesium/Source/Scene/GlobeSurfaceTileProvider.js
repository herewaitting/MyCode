...
function createTileUniformMap(frameState, globeSurfaceTileProvider) {
  var uniformMap = {
    // 史廷春
    u_enableGlobeLight: function() {
      return ExpandBySTC.enableGlobeLight;
    },
    u_showTailorOnly: function() {
      return ExpandBySTC.showTailorOnly;
    },
    u_tailorArea: function() {
      if (ExpandBySTC.tailorArea && ExpandBySTC.tailorArea._colorTextures && ExpandBySTC.tailorArea._colorTextures[0]) {
        return ExpandBySTC.tailorArea._colorTextures[0];
      } else {
        return frameState.context.defaultTexture;
      }
    },
    u_enableTailor: function() {
      return ExpandBySTC.enableTailor;
    },
    u_inverTailorCenterMat: function() {
      return ExpandBySTC.inverTailorCenterMat || new Matrix4();
    },
    u_tailorRect: function() {
      return ExpandBySTC.tailorRect || new Cartesian4();
    },
    u_tailorBrightNum: function() {
      return ExpandBySTC.tailorBrightNum || 1.0;
    },
    u_enableTailorBright: function(){
      return ExpandBySTC.enableTailorBright || false;
    },
    u_baseMapColor:function(){
      return ExpandBySTC.baseMap.color;
    },
    u_baseMapBlend:function(){
        return ExpandBySTC.baseMap.blend;
    },
