...
import ExpandBySTC from "../Kedacom/ExpandBySTC.js"
    ...
    function requestContent(tileset, tile) {
        if (ExpandBySTC.GridTileOpt.cameraMoving && !ExpandBySTC.GridTileOpt.allowRequestImg) {
            return
        }
    ...
    function processTiles(tileset, frameState) {
        ...
        for (var i = 0; i < length; ++i) {
            if (tiles[i].content && tiles[i].content._model && tiles[i].content._model.gltf) {
                tiles[i].content._model.gltf.ableCustomLight = tileset.ableCustomLight;
                tiles[i].content._model.gltf.useGradient = tileset.useGradient;
                tiles[i].content._model.gltf.mixNum = tileset.mixNum;
                tiles[i].content._model.gltf.mixColor = tileset.mixColor;
                tiles[i].content._model.gltf.baseColor = tileset.baseColor;
                tiles[i].content._model.gltf.customMetalness = tileset.customMetalness;
                tiles[i].content._model.gltf.customRoughness = tileset.customRoughness;
            }
            if (tiles[i].content && tiles[i].content._contents && tiles[i].content._contents.length) {
                for (var jj = 0; jj < tiles[i].content._contents.length; jj++) {
                  tiles[i].content._contents[jj]._model.gltf.ableCustomLight = tileset.ableCustomLight;
                  tiles[i].content._contents[jj]._model.gltf.useGradient = tileset.useGradient;
                  tiles[i].content._contents[jj]._model.gltf.mixNum = tileset.mixNum;
                  tiles[i].content._contents[jj]._model.gltf.mixColor = tileset.mixColor;
                  tiles[i].content._contents[jj]._model.gltf.baseColor = tileset.baseColor;
                  tiles[i].content._contents[jj]._model.gltf.customMetalness = tileset.customMetalness;
                  tiles[i].content._contents[jj]._model.gltf.customRoughness = tileset.customRoughness;
                }
            }
