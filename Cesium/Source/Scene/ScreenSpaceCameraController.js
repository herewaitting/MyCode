...
function spin3D(controller, startPosition, movement) {
  ...
  startPosition.x = startPosition.x / ExpandBySTC.canvasScale.x;
  startPosition.y = startPosition.y / ExpandBySTC.canvasScale.y;
...
function rotate3D(
  ...
  if (camera.pitch > CesiumMath.toRadians(ExpandBySTC.limitPitch) && movement.startPosition.y > movement.endPosition.y) {
    return;
  }
...
function pan3D(controller, startPosition, movement, ellipsoid) {
  ...
  movement.startPosition.x = movement.startPosition.x / ExpandBySTC.canvasScale.x;
  movement.startPosition.y = movement.startPosition.y / ExpandBySTC.canvasScale.y;
  movement.endPosition.x = movement.endPosition.x / ExpandBySTC.canvasScale.x;
  movement.endPosition.y = movement.endPosition.y / ExpandBySTC.canvasScale.y;
