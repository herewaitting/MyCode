...
import PostProcessStageSampleMode from "../Scene/PostProcessStageSampleMode.js";
 ...
 */
function MyPostProcessStage(options) {
...
Object.defineProperties(MyPostProcessStage.prototype, {
  /**
 ...
 * @private
 */
MyPostProcessStage.prototype._isSupported = function (context) {
 ...
 * @private
 */
MyPostProcessStage.prototype.update = function (context, useLogDepth) {
 ...
 * @private
 */
MyPostProcessStage.prototype.execute = function (
  context,
  colorTexture,
  depthTexture,
  idTexture
 ...
 */
MyPostProcessStage.prototype.isDestroyed = function () {
  return false;
};
 ...
 */
MyPostProcessStage.prototype.destroy = function () {
  releaseResources(this);
  return destroyObject(this);
};
export default MyPostProcessStage;
