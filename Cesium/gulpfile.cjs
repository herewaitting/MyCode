...
function minifyRelease() {
  return combineJavaScript({
    ...
    optimizer: "none",
    optimizer: "uglify2",
    outputDirectory: path.join('cesium-extension/Build', 'Cesium')
  });
}
  ...
  var karma = new Karma.Server(
    {
      ...
      preprocessors: {
        ...
        'Source/STC/**/*.js': ['karma-coverage-istanbul-instrumenter'],
        'Source/Kedacom/**/*.js': ['karma-coverage-istanbul-instrumenter'],
      },
